...
pixi add apache-airflow-providers-common-compat
# for installing globally
pixi global install apache-airflow-providers-common-compat
```
...
It is possible to list all of the versions of `apache-airflow-providers-common-compat` available on your platform:
...
```
pixi search apache-airflow-providers-common-compat --channel conda-forge
```
